...
public class AgentController {
    ...
    @GetMapping("/{id}")
    public Agent getOne(@PathVariable(value="id") long id) throws SQLException {
        return agentRepository.findOne(id);
    }

    @GetMapping("/children")
    public List<Agent> getRoot() throws SQLException {
        return agentRepository.findRoot();
    }

    @GetMapping("/{id}/children")
    public List<Agent> getChildren(@PathVariable(value="id") long id) throws SQLException {
        return agentRepository.findChildren(id);
    }

    @GetMapping("/{id}/resource")
    public List<Resource> getAgentResources(@PathVariable(value="id") long id) throws SQLException {
